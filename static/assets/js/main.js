...
if (nav) {
  ...
  let LogoUrl =
    "https://elinsanocapo.github.io/beta-/img/Screenshot%202023-10-04%2020.36.31.png"; // Declare LogoUrl once
  if (themeId === "Inverted") {
  ...
  const html = `
    ...
    <div class="fixed-nav-bar-right">
      ...
      <a class="navbar-link" href="/./as"><i class="fa-solid fa-phone navbar-icon"></i><an>Tu</an><an>be</an></a>
      <a class="navbar-link" href="/./ts"><i class="fa-solid fa-folder navbar-icon"></i><an>Ch</an><an>at</an></a>
