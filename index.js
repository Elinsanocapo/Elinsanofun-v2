...
const routes = [
  ...
  // Añadir nuevas rutas aquí
  { path: "/flash", file: "flash/index.html" },
];
...
// Añadir rutas para servir archivos estáticos desde las carpetas 'flash' y 'Games'
app.use("/flash", express.static(path.join(__dirname, "flash")));
app.use("/Games", express.static(path.join(__dirname, "Games")));
app.use("/capito", express.static(path.join(__dirname, "capito")));
